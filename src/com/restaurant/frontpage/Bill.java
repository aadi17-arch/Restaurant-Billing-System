...
public class Bill extends JFrame {
	...
	public Bill() {
	    ...
	    lblNewLabel.setForeground(Color.WHITE); // White Text for contrast
	    ...
	    panel_1.setBackground(new Color(236, 240, 241)); // Light Gray
	    ...
	    back.setBackground(new Color(231, 76, 60)); // Red button
	    back.setBounds(10, 10, 89, 30);
	    panel_1.add(back);

	    JPanel panel_2 = new JPanel();
	    panel_2.setBackground(new Color(52, 152, 219)); // Blue
	    ...
	    lblNewLabel_1.setForeground(Color.WHITE); // White text for contrast
	    ...
	    table = new JTable();
	    table.setBackground(new Color(189, 195, 199)); // Light Gray table background
		...
		lblNewLabel_1_1.setBackground(new Color(44, 62, 80)); // #2C3E50 (Dark Blue)
		lblNewLabel_1_1.setForeground(new Color(255, 255, 255)); // #FFFFFF (White)
		lblNewLabel_1_1.setOpaque(true); // Make the background visible
		...
		name.setForeground(new Color(0, 0, 0)); // #000000 (Black)
		...
		custName.setBackground(new Color(236, 240, 241)); // #ECF0F1 (Light Gray)
		custName.setForeground(new Color(0, 0, 0)); // #000000 (Black)
		custName.setBorder(BorderFactory.createLineBorder(new Color(0, 0, 0))); // #000000 (Black Border)
		panel_2_1.add(custName);

		// Validation Label (Empty for now)
		...
		id.setForeground(new Color(0, 0, 0)); // #000000 (Black)
		...
		panel_2_1.setBackground(new Color(236, 240, 241)); // #ECF0F1 (Light Gray)
		...
		btnPrint.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
			      ...
			      try {
			    	String file = "C:/Users/ADITYA/Desktop/BILL PDF/bill.pdf";    
